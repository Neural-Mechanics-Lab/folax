...
def main(fol_num_epochs=10,solve_FE=False,clean_dir=False):
    ...
    working_directory_name = 'nn_output_mechanical_2D_neohooke_pi_fno_param'
    ...
    for eval_id in eval_cases:
        ...
        # solve FE here (with Newton residual tracking)
        fe_setting = {
        ...
        plot_mesh_vec_data(
            model_settings["L"],
            [K_matrix[eval_id,:], FNO_UV[::2], FE_UV[::2], absolute_error[::2]], 
