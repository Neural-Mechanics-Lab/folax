...
def main(fol_num_epochs=10, solve_FE=False, clean_dir=False, restore_param_init=True):
    ...
    # 0) directory & logging
    # ============================================================
    working_directory_name = '1_Param_Transfer_reference_circular'
    ...
    # ============================================================
    parametric_learning = True  # OTF only
    ...
    # ============================================================
    # 8) OTF training (initialized from parametric weights or random)
    # ============================================================
    ...
    for arg in args:
        if arg.startswith("fol_num_epochs="):
            ...
            print(
                ...
                "fol_num_epochs=2000 solve_FE=False clean_dir=False restore_param_init=True"
            )
            sys.exit(1)
