...
from fol.deep_neural_networks.deep_o_net_parametric_operator_learning import PhysicsInformedDeepONetParametricOperatorLearningADLoss
from fol.solvers.fe_nonlinear_residual_based_solver import FiniteElementNonLinearResidualBasedSolver
...
working_directory_name = 'nn_output_thermal_pi_deeponet_2D_PINN_loss'
...
thermal_loss_2d_pinn.Initialize()
...
for test in [0,1,2]:#,1000,2000,3000,4000,5000,6000,7000,8000,8500,9000,9500,9999]:
    eval_id = test
