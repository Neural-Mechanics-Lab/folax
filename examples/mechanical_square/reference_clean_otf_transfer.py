...
def main(fol_num_epochs=10,solve_FE=False,clean_dir=False):
    ...
    # ============================================================
    working_directory_name = 'nn_output_mechanical_2D_neohooke_pi_fno_otf_from_param'
    ...
    mechanical_loss_2d = NeoHookeMechanicalLoss2DQuad("mechanical_loss_2d",
    ...
    num_epochs = 5000
    learning_rate_scheduler = optax.linear_schedule(init_value=1e-4,
                                                    end_value=1e-5,
    ...
    # ============================================================
    # 5) restore parametric weights from slide 2
    # ============================================================
    ...
    # ============================================================
    # 7) OTF training (initialized from parametric weights)
    # ============================================================
    ...
    for eval_id in eval_cases:
        ...
        plt.tight_layout()
        plt.savefig(os.path.join(case_dir,
                    f"newton_residuals_sample_{eval_id}.png"))
        plt.close()
        ...
        plot_mesh_vec_data(
            ...
            Y_axis_name=None,
            show=False,
            file_name=os.path.join(case_dir,
                                   f'plot_results_{eval_id}.png')
        )
